...
while True:
    ...
    for face in faces:
        ...
        lefteye = detect_eye(left_eye)
        righteye = detect_eye(right_eye)
        aspect_ratio = lefteye + righteye / 2

        #Rounding the values to 2 decimal places
        aspect_ratio = round(aspect_ratio, 2)

        #Assuming a value less that 0.16 as a closed eye
        if aspect_ratio < 0.16:
